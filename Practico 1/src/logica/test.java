...
public class test {
	public static void main(String[] args) {
		...
		asientosAvion.add(as13);
		asientosAvion.add(as2);
		asientosAvion.add(as14);
		asientosAvion.add(as3);
		asientosAvion.add(as15);
		asientosAvion.add(as4);
		asientosAvion.add(as16);
		asientosAvion.add(as5);
		asientosAvion.add(as17);
		asientosAvion.add(as6);
		asientosAvion.add(as18);
		asientosAvion.add(as7);
		asientosAvion.add(as19);
		asientosAvion.add(as8);
		asientosAvion.add(as20);
		asientosAvion.add(as9);
		asientosAvion.add(as21);
		asientosAvion.add(as10);
		asientosAvion.add(as22);
		asientosAvion.add(as11);
		asientosAvion.add(as23);
		asientosAvion.add(as12);
		asientosAvion.add(as24);
		...
		Vuelo vu1 = new Vuelo("AR2443", ae1, LocalDateTime.of(2018, 04, 10, 21, 35), ae2,
				LocalDateTime.of(2018, 04, 10, 22, 45), a1, pilotos, v1, pasajeros);
		...
		for (Avion avion : aviones) {
			System.out.println(avion.getModelo() + " (" + avion.getMatricula() + ") - " + avion.getHorasVueloAvion()
					+ " hs de vuelo");
		}
	...
	private static void mostrarHorasPilotos(ArrayList<Piloto> pilotos) {
		for (Piloto piloto : pilotos) {
			...
			System.out.println(piloto.getApellido() + " " + piloto.getNombre() + " - " + calcularEdad(piloto)
					+ " años. " + piloto.getHorasDeVueloPiloto() + " horas de vuelo");

			System.out.println(piloto.getApellido() + " " + piloto.getNombre() + " " + calcularEdad(piloto) + " años "
					+ piloto.getHorasDeVueloPiloto() + " horas de vuelo");
